  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Admin & Customer specific tokens
      ...
      boxShadow: {
        card: '0 2px 8px -2px oklch(0.18 0.02 140 / 0.08), 0 1px 3px -1px oklch(0.18 0.02 140 / 0.06)',
        'card-hover': '0 8px 24px -4px oklch(0.18 0.02 140 / 0.12), 0 2px 8px -2px oklch(0.18 0.02 140 / 0.08)',
      },
      keyframes: {
        'accordion-down': {
          from: { height: '0' },
